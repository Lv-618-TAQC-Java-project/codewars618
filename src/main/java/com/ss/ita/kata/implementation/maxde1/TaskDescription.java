...
import com.ss.ita.kata.implementation.maxde1.Test;
...
//    TWENTYFOUR();
    ...
    private TaskDescription(int id, String description, String dataNeeded) {
        this.id = id;
    ...
    public static String getById(int i) {
        for (TaskDescription t : TaskDescription.values()) {
            if (t.getId() == i) {
