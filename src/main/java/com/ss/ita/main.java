...
import com.ss.ita.kata.implementation.ivannaveselovska.SevenImpl;
import com.ss.ita.kata.implementation.ivannaveselovska.SixImpl;

public class main {
    public static void main(String[] args) {

        String b1 = "1000.00\n125 Market 125.45\n126 Hardware 34.95\n127 Video 7.45\n128 Book 14.32\n129 Gasoline 16.10";
        String b1sol = "Original_Balance:_1000.00\n125_Market_125.45_Balance_874.55\n126_Hardware_34.95_Balance_839.60\n127_Video_7.45_Balance_832.15\n128_Book_14.32_Balance_817.83\n129_Gasoline_16.10_Balance_801.73\nTotal_expense_198.27\nAverage_expense_39.65";

        System.out.println(new SixImpl().balance(b1));
...
////        System.out.println(new SixImpl().mean("London",data));
//
...
//        System.out.println(new SixImpl().nbaCup(resultSheet3, "Boston Celtics"));
